...
<?php require_once 'config_en/head.php'; ?>

<body id="section_1">
    <?php require_once 'config_en/header.php';
    require_once 'config_en/nav.php'; ?>
    <main>
        ...
        <section class="section-padding" id="section_2">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    require_once 'config_en/connection.php';
                    if ($conn) {
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                <div class="custom-block-wrap">
                                    ...
                                    <div class="custom-block">
                                        ...
                                        <a href="donate_details?id=<?= $edoId; ?>" class="custom-btn btn">Donate</a>
                                    </div>
                                </div>
                            </div>
                    <?php
        ...
        <?php require_once('config_en/footer.php'); ?>
